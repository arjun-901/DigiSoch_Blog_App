        ...
        <div className='flex justify-between items-center h-16 fixed w-full z-20 bg-white px-5 border-b'>
            <div className='flex justify-center items-center gap-2'>
                ...
                <Link to={RouteIndex}>
                    ...
                    <h2 className='font-bold bg-black rounded-2xl px-1 '><span className='text-red-500'>Digi</span><span className='text-white'>Soch.</span><span className='text-green-500'>Blogs</span></h2>
                </Link>
            </div>
